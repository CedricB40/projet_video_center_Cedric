 ...
 */
final class Version20260725182410 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Création de la table reset_password_requests pour le bundle SymfonyCasts ResetPassword';
    }
